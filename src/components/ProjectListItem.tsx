...
export function ProjectListItem({
	...
	return (
		<div
			className="w-full h-[64px] md:h-[144px] flex hover:cursor-pointer my-[16px] max-w-full"
			...
			<div className="w-full flex flex-row justify-between gap-[24px] overflow-hidden">
				...
				<div className="flex md:hidden">
					<h2
						className={`${
							isHovered ? "text-[#AFAFAF]" : "text-[#AFAFAF]"
						} font-medium text-[32px] md:text-[64px] w-full leading-none align-bottom transition-all duration-500`}
					>
						{heading}
					</h2>
				</div>
